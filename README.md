...
```PowerShell
java -cp .\target\kafka-telugu-1.0-SNAPSHOT-jar-with-dependencies.jar edu.northwest.telugu.CustomConsumer
```
...
```PowerShell
java -cp .\target\kafka-telugu-1.0-SNAPSHOT-jar-with-dependencies.jar edu.northwest.telugu.CustomProducer
```
